...
def get_result(data_type, history_begin_datetime, history_end_datetime,
    ...
    df.to_csv("pre.csv")
    return np.array(result).reshape(-1, data_type).tolist()
...
def call(*args, **kwargs):
    ...
    result = get_result(data_type, history_begin_datetime, history_end_datetime, predict_begin_datetime,
...
if __name__ == '__main__':
    ...
    param = {
        ...
        "predict_end_datetime": "2020-9-4",
        "history_data": a.tolist()
    }
