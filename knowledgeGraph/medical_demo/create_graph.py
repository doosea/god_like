...
class MedicalGraph:
    def __init__(self):
        ...
        self.graph = Graph("http://localhost:7474", auth=("neo4j", "Dosea0118"))  # 这里填自己的信息
    ...
    def read_nodes(self):
        ...
        return set(drugs), set(foods), set(checks), set(departments), set(producers), set(symptoms), \
               set(diseases), disease_infos, rels_check, rels_recommandeat, rels_noteat, rels_doeat, \
               rels_department, rels_commonddrug, rels_drug_producer, rels_recommanddrug, rels_symptom, \
...
if __name__ == '__main__':
    ...
    # 创建关系
    medical_graph.create_graphrels()
