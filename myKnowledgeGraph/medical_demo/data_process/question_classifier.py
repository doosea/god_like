...
class QuestionClassifier:
    def __init__(self):
        #　特征词路径
        self.disease_path = '../data/dict/disease.txt'
        self.department_path = '../data/dict/department.txt'
        self.check_path = '../data/dict/check.txt'
        self.drug_path = '../data/dict/drug.txt'
        self.food_path = '../data/dict/food.txt'
        self.producer_path = '../data/dict/producer.txt'
        self.symptom_path = '../data/dict/symptom.txt'
        self.deny_path = '../data/dict/deny.txt'
